...
Get the latest APK from [Releases](../../releases). Installing requires allowing apps from unknown sources — see [what this means](https://support.google.com/android/answer/9457058) before proceeding.
